...
if alpha_s['ci_95'][0] > 0:
    print(f"  ✓ alpha Bootstrap 95% CI [{alpha_s['ci_95'][0]:.4f}, {alpha_s['ci_95'][1]:.4f}] "
          f"EXCLUDES zero")
    print(f"    → alpha IS statistically significant (corrects asymptotic conclusion)")
else:
    print(f"  ✗ alpha Bootstrap 95% CI includes zero")

beta_s = boot_stats(beta_boot, 'beta', beta_fit)
print(f"  ✓ beta  Bootstrap 95% CI [{beta_s['ci_95'][0]:.2f}, {beta_s['ci_95'][1]:.2f}] "
